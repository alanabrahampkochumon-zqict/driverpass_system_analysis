...
The goal of this project was to design a web-based system that enables students to book driving lessons, access online tutorials, and complete practice exams. The system proposal was provided by representatives from DriverPass:

**Liam** – Owner of DriverPass
...
A guiding principle in system design is that “you are not the user of the system.” Even when designing or building software, the developer or analyst is rarely the end user. Because of this, it is critical to understand who the users are, what goals they have, and what constraints they face.
...
One of my biggest takeaways from this course is the importance of planning before implementation. While it may feel faster to begin coding immediately, system analysis and design provide the shared blueprint that keeps teams aligned and prevents costly rework later.

In future projects, I plan to place even greater emphasis on user involvement, early validation, and testing. Techniques such as user observation and usability testing are especially valuable, as people often behave differently than they describe. These methods can uncover critical insights that distinguish a good product from a truly successful one.
